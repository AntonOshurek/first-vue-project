<template>
	<div class="article-controls">
		<button class="article-controls__button">Follow {{ articleData.author.username }}</button>
		<button class="article-controls__button article-controls__button--favorite">
			favorite article
